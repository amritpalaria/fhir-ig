# Date/Time Accuracy - 314e FHIR Implementation Guide v1.0.0

## Extension: Date/Time Accuracy 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.314e|current/StructureDefinition/datetime-accuracy)
...
Other representations of profile: [CSV](../StructureDefinition-datetime-accuracy.csv), [Excel](../StructureDefinition-datetime-accuracy.xlsx), [Schematron](../StructureDefinition-datetime-accuracy.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://314e.com/fhir/StructureDefinition/datetime-accuracy"
    },
    {
