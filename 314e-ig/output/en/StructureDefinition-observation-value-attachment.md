# Observation Value Attachment - 314e FHIR Implementation Guide v1.0.0

## Extension: Observation Value Attachment 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.314e|current/StructureDefinition/observation-value-attachment)
...
Other representations of profile: [CSV](../StructureDefinition-observation-value-attachment.csv), [Excel](../StructureDefinition-observation-value-attachment.xlsx), [Schematron](../StructureDefinition-observation-value-attachment.sch) 
...
```json
{
  ...
  "differential" : {
    "element" : [{
      "id" : "Extension",
      "path" : "Extension",
      "short" : "Observation Value Attachment",
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://314e.com/fhir/StructureDefinition/observation-valueAttachment"
    },
    {
