# 314e Non-Microbiology Laboratory Observation - 314e FHIR Implementation Guide v1.0.0

## Resource Profile: 314e Non-Microbiology Laboratory Observation 

 
314e profile for non-microbiology laboratory observations. 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.314e|current/StructureDefinition/observation-lab-nonmicro-314e)
...
Other representations of profile: [CSV](../StructureDefinition-observation-lab-nonmicro-314e.csv), [Excel](../StructureDefinition-observation-lab-nonmicro-314e.xlsx), [Schematron](../StructureDefinition-observation-lab-nonmicro-314e.sch) 
...
```json
{
  ...
  "id" : "observation-lab-nonmicro-314e",
  "extension" : [{
  ...
  "url" : "http://314e.com/fhir/ig/StructureDefinition/observation-lab-nonmicro-314e",
  "version" : "1.0.0",
