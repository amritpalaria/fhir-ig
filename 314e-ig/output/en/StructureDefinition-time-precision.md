# Time Precision - 314e FHIR Implementation Guide v1.0.0

## Extension: Time Precision 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.314e|current/StructureDefinition/time-precision)
...
Other representations of profile: [CSV](../StructureDefinition-time-precision.csv), [Excel](../StructureDefinition-time-precision.xlsx), [Schematron](../StructureDefinition-time-precision.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://314e.com/fhir/StructureDefinition/time-precision"
    },
    {
