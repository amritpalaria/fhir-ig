...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DocumentReference/f:author">
      ...
      <sch:assert test="count(f:extension[@url = 'http://314e.com/fhir/StructureDefinition/documentReference-author-dictationDateTime']) &lt;= 1">extension with URL = 'http://314e.com/fhir/StructureDefinition/documentReference-author-dictationDateTime': maximum cardinality of 'extension' is 1</sch:assert>
